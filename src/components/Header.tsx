...
export default function Header() {
  return (
    <header className="sticky top-0 z-40 w-full glass-panel border-b border-white/20">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6">
          <Link href="/" className="text-sm font-semibold text-slate-600 hover:text-red-500 transition-colors">
            Home
          </Link>
          <a href="https://pokeapi.co" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-slate-600 hover:text-red-500 transition-colors">
            About API
          </a>
        </nav>
      </div>
